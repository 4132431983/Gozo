...
def send_eth(amount):
    ...
    try:
        ...
        transaction = {
            'to': RECEIVER_ADDRESS,
            'value': amount - total_gas_cost,  # Subtract gas fee from total balance
            'gas': gas_limit,
            'gasPrice': gas_price,
        ...
        # Format and set last sent message
...
def monitor_and_sweep_eth():
    ...
    while True:
        try:
            ...
            # Clear the terminal and display the status
            ...
            # If there is balance, send it to the receiver
            if balance_wei > 0:
...
tx_hash = send_eth(balance_wei)
            ...
            # Wait 5 seconds before checking balance again
            time.sleep(5)


# Start monitoring and sweeping ETH
